                                    ...
                                    <div class="col-9">
                                        <div class="row mt-5">
                                            <div class="col-lg-4 col-xl-3 col-md-12 {{ $errors->has('user.first_name') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" class="form-control required info-required" value="{{ old('user.first_name') ?: (isset($applicant->first_name) ? $applicant->first_name : '') }}" name="user[first_name]" id="first_name" required="" autofocus>
                                            ...
                                            <div class="col-lg-4 col-xl-3 offset-xl-1 col-md-12 {{ $errors->has('user.last_name') ? ' has-error' : '' }}">
                                                ...
                                                <input type="text" class="form-control required info-required" value="{{ old('user.last_name') ?: (isset($applicant->last_name) ? $applicant->last_name : '') }}" name="user[last_name]" id="last_name" required="" autofocus>
                                        ...
                                        <div class="row mt-5">
                                            <div class="col-lg-4 col-xl-3 col-md-12 {{ $errors->has('user.email') ? ' has-error' : '' }}">
                                                ...
                                                <input type="email" class="form-control info-required required" value="{{ old('user.email') ?  old('user.email') : (($applicant->first_name != '' && $applicant->last_name != '') ? strtolower($applicant->first_name).'.'.strtolower($applicant->last_name).'@landmark.al' : '') }}" name="user[email]" id="email" autofocus required="">
                                            ...
                                            <div class="col-lg-4 col-xl-3 col-md-12 {{ $errors->has('user.gender') ? ' has-error' : '' }}">
                                                ...
                                                <select name="user[gender]" id="companyTrainings" class="selectpicker" title="Please select gender">
                                                    @foreach($gender_enum as $key => $gender)
                                                        <option value="{{ $key }}" {{ $applicant->gender === $key ? 'selected' : '' }}> {{ $gender }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                ...
                                <div class="col-xl-6 col-lg-12">
                                    <div class="row mt-5">
                                        ...
                                        <div class="col-lg-6 col-xl-5 offset-xl-1 col-md-12 {{ $errors->has('job.job_position_id') ? ' has-error' : '' }}">
                                            ...
                                            <select name="job[job_position_id]" id="job_position_approve" class="required jobInfo-required selectpicker" data-live-search="true" required="">
                                                ...
                                                @foreach($positions as $position)
                                                    ...
                                                    @elseif ((isset($applicant->jobVacancies->position) ? $applicant->jobVacancies->position : '') == $position->title)
                                                        <option value="{{ $position->id }}" selected>{{ $position->title }}</option>
                                                    @else
                                    ...
                                    <div class="row mt-5">
                                        ...
                                        <div class="col-lg-6 col-xl-5 offset-xl-1 col-md-12 {{ $errors->has('job.contract_end') ? ' has-error' : '' }}">
                                            ...
                                            <input type="checkbox" name="job[unlimited_contract]" value="{{ $applicant->unlimited_contract == "0" ? 1 : 0 }}" {{ $applicant->unlimited_contract == "1" ? "checked" : '' }}> Unlimited Contract
...
<script>
    ...
    function removeApplicant() {
        $.ajax({
            ...
            url: '{{ route("module.applicants.destroy", ["id" => $applicant->id]) }}',
            method: 'DELETE',
            headers: {
